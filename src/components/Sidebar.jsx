...
const linkData = [
  ...
  },
  {
    label: "Staff",
    link: "team",
    icon: <img src={Staff} style={{width:'20px', height:'15px'}}/>,
    adminOnly: true, // Added adminOnly flag
  },
  {
    label: "Trash",
    link: "trashed",
...
const Sidebar = () => {
  ...
  const sidebarLinks = linkData.filter(link => !link.adminOnly || (link.adminOnly && user.isAdmin)); // Filter links
