...
const NotificationPanel = () => {
  ...
  const viewHandler = async (el) => {
    ...
    // Post the activity related to the task
    try {
      const activityData = {
        type: "notification", // Or another type depending on the notification type
        activity: `Notification viewed: ${el.text}`,
        id: el.taskId, // Assuming the notification is related to a specific task
      };

      await postTaskActivity({ data: activityData }).unwrap();
    } catch (error) {
