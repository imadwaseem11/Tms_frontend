...
const TaskDetails = () => {
  const { id } = useParams();
  console.log("Task ID:", id); // Debug: Log the ID
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log("Submitting activity data:", activityData); // Debug: Log activity data

      const result = await postActivity({ data: activityData }).unwrap();
      setText("");
      toast.success(result?.message);
      refetch();
    } catch (error) {
      console.error("Error submitting activity:", error); // Debug: Log error
